module.exports = function(grunt) {
   ...
   // if (typeof commonJSFiles !== "undefined" && getSize(commonJSFiles) > 0) {
   //     for (var common in commonJSFiles) {
           
   //         if ( common != 'inline' && commonJSFiles.hasOwnProperty(common)) {
   //             if ( is_page ) {
   //                 commonJSFiles[common].src = [ commonJSFiles[common].src.slice(-1)[0] ];
   //             }
   //             JSFiles.push(commonJSFiles[common]);
   //         }
   //     }
   // }
